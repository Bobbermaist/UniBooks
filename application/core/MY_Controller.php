...
class MY_Controller extends CI_Controller  {
	...
	/**
	 * *First* exception code catched by "_try" method.
	 *
	 * @var int
	 * @access protected
	 */
	...
	/**
	 * *First* exception message catched
	 * by the "_try" method.
	 *
	 * @var string
	 * @access protected
	...
	/**
	 * Return FALSE if no exceptions were catch
	 * or int with first exception code caught
	 *
	 * @return int|false
	 * @access protected
	 */
	protected function _caught_exception()
	{
		return ($this->exception_code === NO_EXCEPTIONS) ? FALSE : $this->exception_code;
	}

	/**
	 * Executes a try - catch command through a callback.
	 *
	 * If an exception was previously catched does nothing;
	 *
	...
	protected function _set_message($name = FALSE)
	{
		if ($this->_caught_exception() !== FALSE)
		{
			$this->_enqueue_exception_message();
		}
		elseif ($name !== FALSE)
		{
